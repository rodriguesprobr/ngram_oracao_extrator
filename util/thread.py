...
def processar_comunicacao_cientifica(comunicacao_cientifica, nlp, preprocessor):
    ...
    if comunicacao_cientifica_thread is not False:
        processar_comunicacao_cientifica(comunicacao_cientifica_thread, nlp, preprocessor)
